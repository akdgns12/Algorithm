...
public class 복습2_인구이동 {
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println(move()); // 인구이동이 일어나지 않을때까지 반복 
	}
	...
	// 인구이동한 후 각 맵에 설정해줄 평균값구하기
	public static void changePolpulation(int sum) {
